...
<div class="widget-body <?php echo ((!empty($BRANDS) && (isset($BRANDS['results']) && count($BRANDS['results']) > 0 )) ? 'no-padding' : 'padding') ?>">

    <table class="table table-striped table-bordered table-hover" width="100%">
        <?php
            if (!empty($BRANDS) && (isset($BRANDS['results']) && count($BRANDS['results']) > 0 )) {
        ?>
        <thead>			                
            <tr>
                <th data-class="expand">Brand Name</th>
                <th>Slug</th>
                <th></th>
            </tr>
            ...
            <?php
                foreach ($BRANDS['results'] as $brand) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $brand->brand_slug ?></td>
                        <td>
                            <a href="#" id="brand__<?php echo $brand->brand_id; ?>" class="editpage"><i class="fa fa-edit fa-2x"></i></a> &nbsp;
                            <a id="delete__<?php echo $brand->brand_id ?>" href="#" class="openModal"> <i class="fa fa fa-trash-o fa-2x"></i></a>
                        </td>
                    </tr>
                <?php
                }
        ...
        <input type="hidden" name="list_brand_id" id="list_brand_id" value="">
    </table>
    <div class="">
        <div >
            <div>
            <?php
                    $uri = '';
                    buildPagination($BRANDS['param'], $uri);
            ?>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3>Are you sure ?</h3>
                <p>
                    Please confirm you want to delete this brand. THIS ACTION IS NOT REVERSIBLE
                </p>
            </div>
