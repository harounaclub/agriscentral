<script type="text/javascript">
    ...
    function getProjectForm(projectId) {
        record_id = projectId;
        dynamicType = 'list';
        var field = "project";
        postArray = {
                    ...
                    <div class="col-xs-12 col-sm-10">
                        <div class="dataTables_filter">
                            <label>
                                ...
                                <input type="text" id="filter__project" name="filter__project" class="search fr form-control" placeholder="Filter..." />
