<script type="text/javascript">
    ...
    $(document).ready(function() {
       getEquipmentList();
       getEquipmentForm(equipmentId, null);
    });
    ...
    function getEquipmentForm(equipmentId, copyaction) {
    ...
    <div class="row">
        ...
        <article class="col-sm-12 col-md-12 col-lg-6 sortable-grid ui-sortable">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark jarviswidget-sortable" data-widget-editbutton="true" style="" role="widget">
                <!--
                <a  href="/equipment/equipment/generate">
                    ...
                    <div class="col-xs-12 col-sm-10">
                        <div class="dataTables_filter">
                            <label>
                                ...
                                <input type="text" id="filter__equipment" name="filter__equipment" class="search fr form-control" placeholder="Filter..." />
                            </label>
